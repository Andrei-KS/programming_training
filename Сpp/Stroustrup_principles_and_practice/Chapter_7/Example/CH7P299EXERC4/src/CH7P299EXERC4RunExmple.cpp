...
/*
	...
	(2/3)!;		//	error: info lost
*/
#include "CH7P299EXERC4RunExmple.h"
#include "std_lib_facilities.h"

RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH7P299EXERC4RunExmple();
...
namespace {
	...
	*/
	...
	public:
		...
		* @param constancy - determines the possibility of changing this variable in the future
		* @return val
		*/
...
int CH7P299EXERC4RunExmple::excute()
{
	try
	{
		// predefine names:
