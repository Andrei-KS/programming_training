...
#include "CH4P167TASK11RunExmple.h"
#include "std_lib_facilities.h"

RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH4P167TASK11RunExmple();

namespace {
}

int CH4P167TASK11RunExmple::excute()
{
