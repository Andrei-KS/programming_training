/*
	...
	date generate												: 07/07/2022 17:31:55
	author														: Andrei-KS
*/

#include "CH10P376DRILL6_7RunExmple.h"
#include "std_lib_facilities.h"

RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH10P376DRILL6_7RunExmple();
...
int CH10P376DRILL6_7RunExmple::excute()
{
	...
	fill_to_file(original_points, "mydata.txt");
	...
	if (is_copy)
	{
		std::cout << "Both vectors is similar\n";
