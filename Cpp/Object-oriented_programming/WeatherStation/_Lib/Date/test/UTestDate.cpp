...
myUTest* myUTest::Utest = new UTestDate();

void UTestDate::excute()
{
	TestAmountOfDaysMonth();
	TestAmountOfDaysYear();
	TestOrderOfDate();
	TestAddDays();
	TestGetDate();
	TestSubtractionDays();
...
void UTestDate::TestAmountOfDaysMonth()
{
...
void UTestDate::TestAmountOfDaysYear()
{
	// amount of days in leap and non-leap years
...
void UTestDate::TestOrderOfDate()
{
...
void UTestDate::TestSubtractionDays()
{
...
void UTestDate::TestGetDayOfWeek()
{
