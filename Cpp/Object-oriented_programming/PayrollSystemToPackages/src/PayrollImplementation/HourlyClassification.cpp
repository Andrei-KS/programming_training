...
void HourlyClassification::AddItem(Date& date, double value, PaymentClassification* thisObject)
{
	if (HourlyClassification* hc = dynamic_cast<HourlyClassification*>(thisObject))
	{
		hc->AddTimeCard(date, value);
	}
	else
	{
