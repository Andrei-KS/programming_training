...
#include "CH12P438EXERC12_FLTKRunExmple.h"
#include "std_lib_facilities.h"
#include "Simple_window.h"
#include "Graph.h"

RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH12P438EXERC12_FLTKRunExmple();
...
namespace {
  ...
  const int maxNeighboringConnectDistance = 2;
...
int CH12P438EXERC12_FLTKRunExmple::excute()
{
  ...
  if (pointsAmountOnQuadrant > 0)
  {
    ...
    superellipse = new Graph_lib::Lines();
    ...
    superellipse->set_color(Graph_lib::Color::red);
