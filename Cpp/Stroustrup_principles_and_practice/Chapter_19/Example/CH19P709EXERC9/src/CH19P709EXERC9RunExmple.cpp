...
#include "CH19P709EXERC9RunExmple.h"
#include "std_lib_facilities.h"

RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH19P709EXERC9RunExmple();
...
int CH19P709EXERC9RunExmple::excute()
{
  {
    ...
    myVector<double, myAllocator<double>> mv3;
    mv3 = mv2;
    mv3.printAll();
  }
  return 0;
