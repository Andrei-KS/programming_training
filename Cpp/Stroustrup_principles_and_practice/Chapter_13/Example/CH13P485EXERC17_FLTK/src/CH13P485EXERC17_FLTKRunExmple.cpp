...
#include "CH13P485EXERC17_FLTKRunExmple.h"
...
RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH13P485EXERC17_FLTKRunExmple();
...
int CH13P485EXERC17_FLTKRunExmple::excute()
{
  Graph_lib::Point windowLeftTopCorner{ xWindowLeftTopCorner, yWindowLeftTopCorner };
  Graph_lib::Simple_window sWindow(windowLeftTopCorner, windowWidth, windowHeight, "CH13P485EXERC17_FLTKRunExmple");
