...
int CH13P485EXERC14_FLTKRunExmple::excute()
{
  ...
  int color = 0;
  Graph_lib::Right_triangle rightAngle1{ Graph_lib::Point{xIndent,yIndent}, sideLength,sideLength,270 };
  rightAngle1.set_color(Graph_lib::Color(color++));
  rightAngle1.set_fill_color(Graph_lib::Color(color++));
  sWindow.attach(rightAngle1);

  Graph_lib::Right_triangle rightAngle2{ Graph_lib::Point{xIndent + sideLength, yIndent + sideLength},sideLength,sideLength,90 };
  rightAngle2.set_color(Graph_lib::Color(color++));
  rightAngle2.set_fill_color(Graph_lib::Color(color++));
  sWindow.attach(rightAngle2);

  Graph_lib::Right_triangle rightAngle3{ Graph_lib::Point{xIndent + sideLength, yIndent + sideLength},sideLength,sideLength,0 };
  rightAngle3.set_color(Graph_lib::Color(color++));
  rightAngle3.set_fill_color(Graph_lib::Color(color++));
  sWindow.attach(rightAngle3);

  Graph_lib::Right_triangle rightAngle4{ Graph_lib::Point{xIndent + sideLength, yIndent + sideLength},sideLength,sideLength,270 };
  rightAngle4.set_color(Graph_lib::Color(color++));
  rightAngle4.set_fill_color(Graph_lib::Color(color++));
  sWindow.attach(rightAngle4);

  Graph_lib::Right_triangle rightAngle5{ Graph_lib::Point{xIndent + 2 * sideLength, yIndent + 2 * sideLength},sideLength,sideLength,90 };
  rightAngle5.set_color(Graph_lib::Color(color++));
  rightAngle5.set_fill_color(Graph_lib::Color(color++));
  sWindow.attach(rightAngle5);

  Graph_lib::Right_triangle rightAngle6{ Graph_lib::Point{xIndent + 2 * sideLength, yIndent + 2 * sideLength},sideLength,sideLength,0 };
  rightAngle6.set_color(Graph_lib::Color(color++));
  rightAngle6.set_fill_color(Graph_lib::Color(color++));
  sWindow.attach(rightAngle6);

  Graph_lib::Right_triangle rightAngle7{ Graph_lib::Point{xIndent + 1 * sideLength, yIndent + 2 * sideLength},sideLength,sideLength,270 };
  rightAngle7.set_color(Graph_lib::Color(color++));
  rightAngle7.set_fill_color(Graph_lib::Color(color++));
  sWindow.attach(rightAngle7);

  Graph_lib::Right_triangle rightAngle8{ Graph_lib::Point{xIndent + 2 * sideLength, yIndent + 3 * sideLength},sideLength,sideLength,90 };
