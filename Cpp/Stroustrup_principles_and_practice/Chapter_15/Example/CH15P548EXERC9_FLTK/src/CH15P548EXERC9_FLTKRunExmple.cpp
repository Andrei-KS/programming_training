...
#include "CH15P548EXERC9_FLTKRunExmple.h"
#include "std_lib_facilities.h"
#include "Simple_window.h"
#include "Graph.h"
#include "Bar_graph.h"

RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH15P548EXERC9_FLTKRunExmple();
...
int CH15P548EXERC9_FLTKRunExmple::excute()
{
  Graph_lib::Simple_window sWindow(Graph_lib::Point{ 50,50 }, 600, 600, "CH15P548EXERC9_FLTKRunExmple");
  ...
  int x_nummber_of_notches = static_cast<int>(BarInfos.size());
  double x_value_per_notch = (db[db.size()-1].height - db[0].height) / x_nummber_of_notches;

  Graph_lib::Axis xAxis{ Graph_lib::Axis::x, Graph_lib::Point{X_LEFT_TOP_CORNER, Y_LEFT_TOP_CORNER + HEIGHT_BAR_GRAPH}, WIDTH_BAR_GRAPH, x_nummber_of_notches, string("height 1 == ") + to_string(x_value_per_notch) + " cm"};
  xAxis.set_color(Graph_lib::Color::red);

  int y_nummber_of_notches = 10;
  double y_value_per_notch = (bg.maxValue() - bg.minValue()) / y_nummber_of_notches;

  Graph_lib::Axis yAxis{ Graph_lib::Axis::y, Graph_lib::Point{X_LEFT_TOP_CORNER, Y_LEFT_TOP_CORNER + HEIGHT_BAR_GRAPH}, HEIGHT_BAR_GRAPH, y_nummber_of_notches, string("people_amount 1 == ") + to_string(y_value_per_notch) };
