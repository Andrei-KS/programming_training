...
#include "CH20P754EXERC5RunExmple.h"
#include "std_lib_facilities.h"

RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH20P754EXERC5RunExmple();
...
namespace {
  ...
  {
    for (int index = 0; index < container.sz; ++index)
    {
...
int CH20P754EXERC5RunExmple::excute()
{
