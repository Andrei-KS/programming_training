...
#include "CH20P755EXERC9RunExmple.h"
#include "std_lib_facilities.h"

RunCommandOfExample* RunCommandOfExample::runCommandOfExample = new CH20P755EXERC9RunExmple();
...
int CH20P755EXERC9RunExmple::excute()
{
